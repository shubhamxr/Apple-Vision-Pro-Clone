...
var tl = gsap.timeline({
  scrollTrigger: {
    trigger: "#page1",
    start: "top top",
    end: "+=100%", // adjust karo yeh value text ke upar jaane ke duration ke liye
    scrub: 1,
    scroller: "#main",
    pin: true,
  },
...
tl.fromTo(
  "#page1 h1",
  { y: "100%" }, // text neeche se shuru ho
  { y: "-100%", ease: "none" } // text upar chala jaye
);
...
tl1.to(["#page2>h3", "#page2>h1"], {
  top: "-50%",  // dono ek sath upar jayenge
}); 
...
tl1.to(["#page6>h3", "#page6>h1"], {
  top: "-50%",  // dono ek sath upar jayenge
});
function canvas(){
  const canvas = document.querySelector("#page7s>canvas");
